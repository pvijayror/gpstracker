...
collected_measurement = CollectedMeasurement.new(device_id: device.id, longitude: "77.02", latitude: "12.04", traced_route_id: traced_route.id)
collected_measurement.save(:validate => false) 

collected_measurement = CollectedMeasurement.new(device_id: device.id, longitude: "78.02", latitude: "12.11", traced_route_id: traced_route.id)
collected_measurement.save(:validate => false) 

collected_measurement = CollectedMeasurement.new(device_id: device.id, longitude: "79.02", latitude: "13.04", traced_route_id: traced_route.id)
collected_measurement.save(:validate => false) 

collected_measurement = CollectedMeasurement.new(device_id: device.id, longitude: "80.02", latitude: "13.34", traced_route_id: traced_route.id)
collected_measurement.save(:validate => false) 

collected_measurement = CollectedMeasurement.new(device_id: device.id, longitude: "80.82", latitude: "13.44", traced_route_id: traced_route.id)
collected_measurement.save(:validate => false) 

collected_measurement = CollectedMeasurement.new(device_id: device.id, longitude: "81.02", latitude: "14.04", traced_route_id: traced_route.id)
collected_measurement.save(:validate => false) 

collected_measurement = CollectedMeasurement.new(device_id: device.id, longitude: "81.52", latitude: "14.14", traced_route_id: traced_route.id)
collected_measurement.save(:validate => false) 

collected_measurement = CollectedMeasurement.new(device_id: device.id, longitude: "82.32", latitude: "14.24", traced_route_id: traced_route.id)
collected_measurement.save(:validate => false) 

collected_measurement = CollectedMeasurement.new(device_id: device.id, longitude: "82.92", latitude: "14.94", traced_route_id: traced_route.id)
collected_measurement.save(:validate => false) 
